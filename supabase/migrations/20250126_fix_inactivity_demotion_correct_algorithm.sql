-- =====================================================
-- Migration: Fix inactivity demotion algorithm (CORRECT)
-- Date: 2025-01-26
-- =====================================================
-- ALGORITMO CORRETTO:
-- 1. Retrocedi tutti gli inattivi di 1 posizione
-- 2. Crea lista degli attivi in ordine di posizione
-- 3. Riempi i buchi dall'alto con gli attivi
-- 4. Ricompatta eventuali buchi rimasti
--
-- ESEMPIO:
-- Input:  1° riccardo (attivo), 2° alessio (inattivo), 3° player11 (attivo),
--         4° matteo (inattivo), 5° player13 (inattivo), 6° player10 (attivo),
--         7° player5 (inattivo), 8° alessia (inattivo), 9° player9 (attivo),
--         10° player7 (inattivo), 11° player12 (inattivo), 12° player8 (inattivo)
--
-- Step 1 - Retrocedi inattivi:
--   1° [vuoto], 2° [vuoto], 3° alessio, 4° [vuoto], 5° matteo, 6° player13,
--   7° [vuoto], 8° player5, 9° alessia, 10° [vuoto], 11° player7, 12° player12, 13° player8
--
-- Step 2 - Lista attivi in ordine:
--   riccardo (pos 1), player11 (pos 3), player10 (pos 6), player9 (pos 9)
--
-- Step 3 - Riempi buchi con attivi:
--   1° riccardo, 2° player11, 3° alessio, 4° player10, 5° matteo, 6° player13,
--   7° player9, 8° player5, 9° alessia, 10° [vuoto], 11° player7, 12° player12, 13° player8
--
-- Step 4 - Ricompatta (elimina buco pos 10):
--   1° riccardo, 2° player11, 3° alessio, 4° player10, 5° matteo, 6° player13,
--   7° player9, 8° player5, 9° alessia, 10° player7, 11° player12, 12° player8
-- =====================================================
